export const projects = [
  ...
  },
  {
    ...
    views: [
      { label: "Poster identity", image: "/images/orbit-01.svg" },
      { label: "Campaign mockup", image: "/images/orbit-02.svg" },
    ],
    accent: "#6f5cff",
  ...
  },
  {
    ...
    views: [
      { label: "Visual identity", image: "/images/selam-01.svg" },
      { label: "Product mockup", image: "/images/selam-02.svg" },
    ],
    accent: "#3f624e",
  ...
  },
  {
    ...
    views: [
      { label: "Poster identity", image: "/images/kinetic-01.svg" },
      { label: "Type mockup", image: "/images/kinetic-02.svg" },
    ],
    accent: "#151515",
