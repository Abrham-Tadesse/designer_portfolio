    ...
    <section className="mx-auto max-w-[1500px] px-5 py-16 md:px-10 md:py-28">
      ...
      <div className="mt-16 grid gap-10 border-t border-black/15 pt-10 md:mt-24 md:grid-cols-12">
        ...
        <div className="md:col-span-5">
          <a href="mailto:hello@norastudio.design" className="group flex items-center justify-between border-b border-black py-4 text-xl font-semibold">
            <span className="flex items-center gap-3"><Mail size={20} /> hello@norastudio.design</span>
